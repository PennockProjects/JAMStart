<!--
MonkInset - a Nuxt.js NuxtContent component from Pennock Projects, MIT License, Copyright (c) 2024 John P. Pennock
version: 1.0
-->
<script setup>
...
const fullSizeStrings = ['extra small', 'small', 'medium', 'large', 'extra large']
const sizeStrings = ['xs', 'sm', 'md', 'lg', 'xl']

// support unabbreviated strings
if(fullSizeStrings.includes(sizeString.value)) {
  sizeString.value = sizeStrings[fullSizeStrings.indexOf(sizeString.value)]
}

// normalize to supported strings
